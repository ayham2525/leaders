...
<body <?php body_class(); ?>>
  ...
  <div id="wrapper">
    ...
    <div class="floating-quicklinks">
      <a href="https://wa.me/971508498843" target="_blank" rel="noopener" aria-label="WhatsApp">
        <!-- WhatsApp SVG -->
      ...
      <a href="tel:+971508498843" aria-label="Call us">
        <!-- Phone SVG -->
        <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
      ...
      <a href="mailto:info@leaderssports.ae" aria-label="Email us">
        <!-- Mail SVG -->
        <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
      ...
      <a href="https://www.instagram.com/leaderssportsservices/" target="_blank" rel="noopener" aria-label="Instagram">
        <!-- Instagram SVG -->
        <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
